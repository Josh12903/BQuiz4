...
<div class="pp all" style="display:flex;margin:auto">
    <div class="pp ct" style="width:60%;padding:10px;border:1px solid white">
        <a href="?do=detail&id=<?=$row['id'];?>"></a>
        <img src="pic/<?=$row['img'];?>" style="width:150px;height:120px">
    </div>
    <div style="width:40%">
        <div class="pp" style="border:1px solid white">分類:<?=$Type->find($row['big'])['name'];?> > <?=$Type->find($row['mid'])['name'];?></div>
